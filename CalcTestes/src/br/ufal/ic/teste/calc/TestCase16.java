...
public class TestCase16 extends TestCase {
	...
	public void test14() throws Exception {
		...
		driver.findElement(By.xpath("(//td[@onclick='add(this.innerHTML)'])[15]")).click();
		driver.findElement(By.xpath("(//td[@onclick='add(this.innerHTML)'])[8]")).click();
		driver.findElement(By.cssSelector("td.cor2")).click();
		assertEquals("40", driver.findElement(By.id("exp_")).getAttribute("value"));
	}
